...
(*{| rule `<T>`(`<par>`(`_ProcCellBag_`(`<proc>`(`<k>`(`` `New`(X,P)=>P``~>DotVar3),`<bounds>`(`_BoundCellBag_`(`` `.BoundCellBag`(.KList)=>`<bound>`(X)``,DotVar4)),DotVar2),DotVar1))) requires `_andBool_`(isProc(P),isName(X)) ensures #token("true","Bool") [UNIQUE_ID(61f877a35c585e40dafd331540b1e7ab78b1517fa811a21ba9fd5499641f4a93) contentStartColumn(8) contentStartLine(73) org.kframework.attributes.Location(Location(73,8,74,61)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Pi-Calc/./pi.k)) org.kframework.definition.Production(syntax RuleContent ::= K) structural()]|}*)
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(KApply2(LblNew,(varX_250 :: []),(varP_251 :: [])) :: varDotVar3_252)) :: []),(KApply1(Lbl'_LT_'bounds'_GT_',((eval_BoundCellBag_(((Lazy.force const'Stop'BoundCellBag) :: []),(varDotVar4_253 :: [])) config (-1)) :: [])) :: []),(varDotVar2_254)) :: []),(varDotVar1_255 :: [])) config (-1)) :: [])) :: [])) :: []) when (((isTrue (evalisProc((varP_251 :: [])) config (-1)))) && ((isTrue (evalisName((varX_250 :: [])) config (-1))))) && (true) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varP_251 :: varDotVar3_252)) :: []),(KApply1(Lbl'_LT_'bounds'_GT_',((eval_BoundCellBag_((KApply1(Lbl'_LT_'bound'_GT_',(varX_250 :: [])) :: []),(varDotVar4_253 :: [])) config (-1)))) :: []),(varDotVar2_254)) :: []),(varDotVar1_255 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
(*{| rule `<T>`(`<par>`(`_ProcCellBag_`(`` `<proc>`(`<k>`(.K),DotVar2,`<sum>`(`.SummandCellBag`(.KList)))=>`.ProcCellBag`(.KList)``,DotVar1))) requires #token("true","Bool") ensures #token("true","Bool") [UNIQUE_ID(f1be5fadeffa85f0fe2b2241aa9fae05df387e43c36aeae3d3687437f66025e3) contentStartColumn(8) contentStartLine(67) org.kframework.attributes.Location(Location(67,8,67,65)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Pi-Calc/./pi.k)) org.kframework.definition.Production(syntax RuleContent ::= K) structural()]|}*)
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',([])) :: []),(varDotVar2_256),(KApply1(Lbl'_LT_'sum'_GT_',((Lazy.force const'Stop'SummandCellBag) :: [])) :: [])) :: []),(varDotVar1_257 :: [])) config (-1)) :: [])) :: [])) :: []) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_(((Lazy.force const'Stop'ProcCellBag)),(varDotVar1_257 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
...
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varN_258 :: [])) :: []),(varDotVar2_259),(KApply1(Lbl'_LT_'sum'_GT_',((Lazy.force const'Stop'SummandCellBag) :: [])) :: [])) :: []),(varDotVar1_260 :: [])) config (-1)) :: [])) :: [])) :: []) when (isTrue (evalisNormProc((varN_258 :: [])) config (-1))) && (true) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',([])) :: []),(varDotVar2_259),(KApply1(Lbl'_LT_'sum'_GT_',(KApply1(Lbl'_LT_'summand'_GT_',(varN_258 :: [])) :: [])) :: [])) :: []),(varDotVar1_260 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
(*{| rule `<T>`(`<par>`(`_ProcCellBag_`(`_ProcCellBag_`(`<proc>`(`<k>`(`` `Par`(P,Q)=>P``),_0,_1),`` `.ProcCellBag`(.KList)=>`<proc>`(`<k>`(Q),initBoundsCell(.KList),initSumCell(.KList))``),DotVar1))) requires `_andBool_`(isProc(Q),isProc(P)) ensures #token("true","Bool") [UNIQUE_ID(62731f8379e3f6eedbb55e64e3c440e8c5d89ad7dde06d3ef4d6f59767d7a98a) contentStartColumn(8) contentStartLine(52) org.kframework.attributes.Location(Location(52,8,53,49)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Pi-Calc/./pi.k)) org.kframework.definition.Production(syntax RuleContent ::= K) structural()]|}*)
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_(((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(KApply2(LblPar,(varP_261 :: []),(varQ_262 :: [])) :: [])) :: []),(var_0_263),(var_1_264)) :: []),((Lazy.force const'Stop'ProcCellBag) :: [])) config (-1)) :: []),(varDotVar1_265 :: [])) config (-1)) :: [])) :: [])) :: []) when (((isTrue (evalisProc((varQ_262 :: [])) config (-1)))) && ((isTrue (evalisProc((varP_261 :: [])) config (-1))))) && (true) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_(((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varP_261 :: [])) :: []),(var_0_263),(var_1_264)) :: []),(KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varQ_262 :: [])) :: []),((Lazy.force constinitBoundsCell)),((Lazy.force constinitSumCell))) :: [])) config (-1))),(varDotVar1_265 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
(*{| rule `<T>`(`<par>`(`_ProcCellBag_`(`<proc>`(_0,_1,`<sum>`(`_SummandCellBag_`(`_SummandCellBag_`(`<summand>`(`` `Or`(N,M)=>N``),`` `.SummandCellBag`(.KList)=>`<summand>`(M)``),DotVar3))),DotVar1))) requires `_andBool_`(isNormProc(M),isNormProc(N)) ensures #token("true","Bool") [UNIQUE_ID(ba87a412350741ced5e7e6daffe704fc1dc320b0f22ea4f4ebe728551adb18a2) contentStartColumn(8) contentStartLine(62) org.kframework.attributes.Location(Location(62,8,63,40)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Pi-Calc/./pi.k)) org.kframework.definition.Production(syntax RuleContent ::= K) structural()]|}*)
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(var_0_266),(var_1_267),(KApply1(Lbl'_LT_'sum'_GT_',((eval_SummandCellBag_(((eval_SummandCellBag_((KApply1(Lbl'_LT_'summand'_GT_',(KApply2(LblOr,(varN_268 :: []),(varM_269 :: [])) :: [])) :: []),((Lazy.force const'Stop'SummandCellBag) :: [])) config (-1)) :: []),(varDotVar3_270 :: [])) config (-1)) :: [])) :: [])) :: []),(varDotVar1_271 :: [])) config (-1)) :: [])) :: [])) :: []) when (((isTrue (evalisNormProc((varM_269 :: [])) config (-1)))) && ((isTrue (evalisNormProc((varN_268 :: [])) config (-1))))) && (true) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(var_0_266),(var_1_267),(KApply1(Lbl'_LT_'sum'_GT_',((eval_SummandCellBag_(((eval_SummandCellBag_((KApply1(Lbl'_LT_'summand'_GT_',(varN_268 :: [])) :: []),(KApply1(Lbl'_LT_'summand'_GT_',(varM_269 :: [])) :: [])) config (-1))),(varDotVar3_270 :: [])) config (-1)))) :: [])) :: []),(varDotVar1_271 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
(*{| rule `<T>`(`<par>`(`_ProcCellBag_`(`<proc>`(_0,_1,`<sum>`(`_SummandCellBag_`(`` `<summand>`(`Nil_PI-SYNTAX`(.KList))=>`.SummandCellBag`(.KList)``,DotVar3))),DotVar1))) requires #token("true","Bool") ensures #token("true","Bool") [UNIQUE_ID(482205607c5d4302c54454babf39445a48640b86144dacef746e2d5bb2d9e643) contentStartColumn(8) contentStartLine(65) org.kframework.attributes.Location(Location(65,8,65,59)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Pi-Calc/./pi.k)) org.kframework.definition.Production(syntax RuleContent ::= K) structural()]|}*)
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(var_0_272),(var_1_273),(KApply1(Lbl'_LT_'sum'_GT_',((eval_SummandCellBag_((KApply1(Lbl'_LT_'summand'_GT_',(KApply0(LblNil_PI'Hyph'SYNTAX) :: [])) :: []),(varDotVar3_274 :: [])) config (-1)) :: [])) :: [])) :: []),(varDotVar1_275 :: [])) config (-1)) :: [])) :: [])) :: []) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(var_0_272),(var_1_273),(KApply1(Lbl'_LT_'sum'_GT_',((eval_SummandCellBag_(((Lazy.force const'Stop'SummandCellBag)),(varDotVar3_274 :: [])) config (-1)))) :: [])) :: []),(varDotVar1_275 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
(*{| rule `<T>`(`<par>`(`_ProcCellBag_`(`` `<proc>`(`<k>`(`Nil_PI-SYNTAX`(.KList)),_0,_1)=>`.ProcCellBag`(.KList)``,DotVar1))) requires #token("true","Bool") ensures #token("true","Bool") [UNIQUE_ID(15ae83fa0302a3e1c3682ca647dfd89129f01e983c6f2cd5590813a01fcfabbd) contentStartColumn(8) contentStartLine(55) org.kframework.attributes.Location(Location(55,8,55,49)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Pi-Calc/./pi.k)) org.kframework.definition.Production(syntax RuleContent ::= K) structural()]|}*)
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(KApply0(LblNil_PI'Hyph'SYNTAX) :: [])) :: []),(var_0_276),(var_1_277)) :: []),(varDotVar1_278 :: [])) config (-1)) :: [])) :: [])) :: []) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_(((Lazy.force const'Stop'ProcCellBag)),(varDotVar1_278 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
(*{| rule `<T>`(`<par>`(`_ProcCellBag_`(`_ProcCellBag_`(`<proc>`(`<k>`(``.K=>`_[_/_]_SUBSTITUTION`(P,Z,Y)``~>DotVar3),DotVar2,`` `<sum>`(`_SummandCellBag_`(`<summand>`(`Receive`(X,Y,P)),DotVar4))=>`<sum>`(`.SummandCellBag`(.KList))``),`<proc>`(`<k>`(``.K=>Q``~>DotVar6),DotVar5,`` `<sum>`(`_SummandCellBag_`(`<summand>`(`Send`(X,Z,Q)),DotVar7))=>`<sum>`(`.SummandCellBag`(.KList))``)),DotVar1))) requires `_andBool_`(`_andBool_`(`_andBool_`(`_andBool_`(isName(Y),isProc(Q)),isName(Z)),isProc(P)),isName(X)) ensures #token("true","Bool") [UNIQUE_ID(fdc216fa1763099e27a924646ec6f24e043c95e48b8dbd9751d1ad5a8b9b36ae) contentStartColumn(8) contentStartLine(82) org.kframework.attributes.Location(Location(82,8,101,15)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Pi-Calc/./pi.k)) org.kframework.definition.Production(syntax RuleContent ::= K)]|}*)
| (KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_(((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varDotVar3_279)) :: []),(varDotVar2_280),(KApply1(Lbl'_LT_'sum'_GT_',((eval_SummandCellBag_((KApply1(Lbl'_LT_'summand'_GT_',(KApply3(LblReceive,(varX_281 :: []),(varY_282 :: []),(varP_283 :: [])) :: [])) :: []),(varDotVar4_284 :: [])) config (-1)) :: [])) :: [])) :: []),(KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varDotVar6_285)) :: []),(varDotVar5_286),(KApply1(Lbl'_LT_'sum'_GT_',((eval_SummandCellBag_((KApply1(Lbl'_LT_'summand'_GT_',(KApply3(LblSend,(varX_287 :: []),(varZ_288 :: []),(varQ_289 :: [])) :: [])) :: []),(varDotVar7_290 :: [])) config (-1)) :: [])) :: [])) :: [])) config (-1)) :: []),(varDotVar1_291 :: [])) config (-1)) :: [])) :: [])) :: []) when (((((((((isTrue (evalisName((varY_282 :: [])) config (-1)))) && ((isTrue (evalisProc((varQ_289 :: [])) config (-1)))))) && ((isTrue (evalisName((varZ_288 :: [])) config (-1)))))) && ((isTrue (evalisProc((varP_283 :: [])) config (-1)))))) && ((isTrue (evalisName((varX_287 :: [])) config (-1))))) && (((compare_kitem varX_287 varX_281) = 0) && true) -> (((KApply1(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'par'_GT_',((eval_ProcCellBag_(((eval_ProcCellBag_((KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',((eval_'LSqB'_'Slsh'_'RSqB'_SUBSTITUTION((varP_283 :: []),(varZ_288 :: []),(varY_282 :: [])) config (-1)) @ varDotVar3_279)) :: []),(varDotVar2_280),(KApply1(Lbl'_LT_'sum'_GT_',((Lazy.force const'Stop'SummandCellBag))) :: [])) :: []),(KApply3(Lbl'_LT_'proc'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varQ_289 :: varDotVar6_285)) :: []),(varDotVar5_286),(KApply1(Lbl'_LT_'sum'_GT_',((Lazy.force const'Stop'SummandCellBag))) :: [])) :: [])) config (-1))),(varDotVar1_291 :: [])) config (-1)))) :: [])) :: [])), (StepFunc step))
