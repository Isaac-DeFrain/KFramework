...
(*{| rule `<T>`(`<activity>`(`_ThreadCellBag_`(`` `.ThreadCellBag`(.KList)=>`<thread>`(`<k>`(`_[_/_]_SUBSTITUTION`(P,Z,Y)))``,DotVar4)),`<tuplespace>`(`<sends>`(`_SendCellBag_`(`` `<send>`(`<schan>`(X),`<msg>`(Z))=>`.SendCellBag`(.KList)``,DotVar2)),`<recs>`(`_RecCellBag_`(`` `<rec>`(`<rchan>`(X),`<bind>`(Y),`<cont>`(P))=>`.RecCellBag`(.KList)``,DotVar3)))) requires `_andBool_`(`_andBool_`(`_andBool_`(isName(Y),isName(Z)),isProc(P)),isName(X)) ensures #token("true","Bool") [UNIQUE_ID(f0b72454b59b73c2a25d2e242ce6bdbe1ba67b4743ead213537124576c92ec52) contentStartColumn(3) contentStartLine(114) klabel(COMM) org.kframework.attributes.Location(Location(114,3,123,49)) org.kframework.attributes.Source(Source(/home/isaac/Documents/Isaac/KFramework/Git/KFramework/Rho-Calc/./rho.k)) org.kframework.definition.Production(syntax RuleContent ::= K)]|}*)
| (KApply2(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'activity'_GT_',((eval_ThreadCellBag_(((Lazy.force const'Stop'ThreadCellBag) :: []),(varDotVar4_364 :: [])) config (-1)) :: [])) :: []),(KApply2(Lbl'_LT_'tuplespace'_GT_',(KApply1(Lbl'_LT_'sends'_GT_',((eval_SendCellBag_((KApply2(Lbl'_LT_'send'_GT_',(KApply1(Lbl'_LT_'schan'_GT_',(varX_365 :: [])) :: []),(KApply1(Lbl'_LT_'msg'_GT_',(varZ_366 :: [])) :: [])) :: []),(varDotVar2_367 :: [])) config (-1)) :: [])) :: []),(KApply1(Lbl'_LT_'recs'_GT_',((eval_RecCellBag_((KApply3(Lbl'_LT_'rec'_GT_',(KApply1(Lbl'_LT_'rchan'_GT_',(varX_368 :: [])) :: []),(KApply1(Lbl'_LT_'bind'_GT_',(varY_369 :: [])) :: []),(KApply1(Lbl'_LT_'cont'_GT_',(varP_370 :: [])) :: [])) :: []),(varDotVar3_371 :: [])) config (-1)) :: [])) :: [])) :: [])) :: []) when (((((((isTrue (evalisName((varY_369 :: [])) config (-1)))) && ((isTrue (evalisName((varZ_366 :: [])) config (-1)))))) && ((isTrue (evalisProc((varP_370 :: [])) config (-1)))))) && ((isTrue (evalisName((varX_368 :: [])) config (-1))))) && (((compare_kitem varX_368 varX_365) = 0) && true) -> (((KApply2(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'activity'_GT_',((eval_ThreadCellBag_((KApply1(Lbl'_LT_'thread'_GT_',(KApply1(Lbl'_LT_'k'_GT_',((eval_'LSqB'_'Slsh'_'RSqB'_SUBSTITUTION((varP_370 :: []),(varZ_366 :: []),(varY_369 :: [])) config (-1)))) :: [])) :: []),(varDotVar4_364 :: [])) config (-1)))) :: []),(KApply2(Lbl'_LT_'tuplespace'_GT_',(KApply1(Lbl'_LT_'sends'_GT_',((eval_SendCellBag_(((Lazy.force const'Stop'SendCellBag)),(varDotVar2_367 :: [])) config (-1)))) :: []),(KApply1(Lbl'_LT_'recs'_GT_',((eval_RecCellBag_(((Lazy.force const'Stop'RecCellBag)),(varDotVar3_371 :: [])) config (-1)))) :: [])) :: [])) :: [])), (StepFunc step))
...
| (KApply2(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'activity'_GT_',((eval_ThreadCellBag_((KApply1(Lbl'_LT_'thread'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(KApply2(LblSend,(varX_372 :: []),(varP_373 :: [])) :: varDotVar5_374)) :: [])) :: []),(varDotVar3_375 :: [])) config (-1)) :: [])) :: []),(KApply2(Lbl'_LT_'tuplespace'_GT_',(KApply1(Lbl'_LT_'sends'_GT_',((eval_SendCellBag_(((Lazy.force const'Stop'SendCellBag) :: []),(varDotVar2_376 :: [])) config (-1)) :: [])) :: []),(varDotVar1_377)) :: [])) :: []) when (((isTrue (evalisProc((varP_373 :: [])) config (-1)))) && ((isTrue (evalisName((varX_372 :: [])) config (-1))))) && (true) -> (((KApply2(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'activity'_GT_',((eval_ThreadCellBag_((KApply1(Lbl'_LT_'thread'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varDotVar5_374)) :: [])) :: []),(varDotVar3_375 :: [])) config (-1)))) :: []),(KApply2(Lbl'_LT_'tuplespace'_GT_',(KApply1(Lbl'_LT_'sends'_GT_',((eval_SendCellBag_((KApply2(Lbl'_LT_'send'_GT_',(KApply1(Lbl'_LT_'schan'_GT_',(varX_372 :: [])) :: []),(KApply1(Lbl'_LT_'msg'_GT_',(KApply1(LblQuote,(varP_373 :: [])) :: [])) :: [])) :: []),(varDotVar2_376 :: [])) config (-1)))) :: []),(varDotVar1_377)) :: [])) :: [])), (StepFunc step))
...
| (KApply2(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'activity'_GT_',((eval_ThreadCellBag_(((eval_ThreadCellBag_(((eval_ThreadCellBag_((KApply1(Lbl'_LT_'thread'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(KApply2(LblPar,(varP1_378 :: []),(varP2_379 :: [])) :: varDotVar2_380)) :: [])) :: []),((Lazy.force const'Stop'ThreadCellBag) :: [])) config (-1)) :: []),((Lazy.force const'Stop'ThreadCellBag) :: [])) config (-1)) :: []),(varDotVar1_381 :: [])) config (-1)) :: [])) :: []),(varDotVar0_382)) :: []) when (((isTrue (evalisProc((varP1_378 :: [])) config (-1)))) && ((isTrue (evalisProc((varP2_379 :: [])) config (-1))))) && (true) -> (((KApply2(Lbl'_LT_'T'_GT_',(KApply1(Lbl'_LT_'activity'_GT_',((eval_ThreadCellBag_(((eval_ThreadCellBag_(((eval_ThreadCellBag_((KApply1(Lbl'_LT_'thread'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varDotVar2_380)) :: [])) :: []),(KApply1(Lbl'_LT_'thread'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varP1_378 :: [])) :: [])) :: [])) config (-1))),(KApply1(Lbl'_LT_'thread'_GT_',(KApply1(Lbl'_LT_'k'_GT_',(varP2_379 :: [])) :: [])) :: [])) config (-1))),(varDotVar1_381 :: [])) config (-1)))) :: []),(varDotVar0_382)) :: [])), (StepFunc step))
